...
var artUnlocked = [true, false, false, false, false];
var artUnlockedT = [true, false, false, false, false];
...
function buyArtifact()  
{
    ...
    if (shapestone >= artUnlockCost && (artUnlocked[1] == false || artUnlocked[2] == false || artUnlocked[3] == false || artUnlocked[4] == false))
    {
        let r = Math.ceil(Math.random(1) * 4);  //randomizing which artifact you get
        switch (r)
        {
            case 1:
